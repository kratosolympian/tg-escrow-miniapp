...
export async function POST(request: NextRequest) {
  try {
    ...
    await sendEscrowStatusNotification(escrow.id, escrow.status, ESCROW_STATUS.IN_PROGRESS, serviceClient, process.env.TELEGRAM_MINIAPP_URL, authenticatedUser.id)
