        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-sm">
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-lg mx-auto mb-3">1</div>
              <h4 className="font-medium mb-2">Create Escrow</h4>
              <p className="text-gray-600">Seller creates transaction with details and gets unique code</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-lg mx-auto mb-3">2</div>
              <h4 className="font-medium mb-2">Buyer Joins</h4>
              <p className="text-gray-600">Buyer enters code, sees details, and makes payment</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-lg mx-auto mb-3">3</div>
              <h4 className="font-medium mb-2">Admin Confirms</h4>
              <p className="text-gray-600">Admin verifies payment and confirms transaction</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 font-bold text-lg mx-auto mb-3">4</div>
              <h4 className="font-medium mb-2">Completion</h4>
              <p className="text-gray-600">Product delivered, buyer confirms, funds released</p>
            </div>
          </div>
        </div>
      </div>
