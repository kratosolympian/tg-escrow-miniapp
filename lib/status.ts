...
export const ALLOWED_TRANSITIONS: Record<EscrowStatus, EscrowStatus[]> = {
  ...
  [ESCROW_STATUS.WAITING_PAYMENT]: [ESCROW_STATUS.WAITING_ADMIN, ESCROW_STATUS.ON_HOLD, ESCROW_STATUS.REFUNDED, ESCROW_STATUS.CLOSED],
  [ESCROW_STATUS.WAITING_ADMIN]: [ESCROW_STATUS.PAYMENT_CONFIRMED, ESCROW_STATUS.REFUNDED, ESCROW_STATUS.ON_HOLD],
  [ESCROW_STATUS.PAYMENT_CONFIRMED]: [ESCROW_STATUS.IN_PROGRESS, ESCROW_STATUS.ON_HOLD, ESCROW_STATUS.REFUNDED],
  [ESCROW_STATUS.IN_PROGRESS]: [ESCROW_STATUS.COMPLETED, ESCROW_STATUS.ON_HOLD, ESCROW_STATUS.REFUNDED],
  [ESCROW_STATUS.COMPLETED]: [ESCROW_STATUS.CLOSED, ESCROW_STATUS.ON_HOLD],
  [ESCROW_STATUS.ON_HOLD]: [ESCROW_STATUS.WAITING_ADMIN, ESCROW_STATUS.REFUNDED, ESCROW_STATUS.IN_PROGRESS, ESCROW_STATUS.CLOSED],
