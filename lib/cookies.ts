...
export function setAuthCookies(resp: NextResponse, accessToken?: string | null, refreshToken?: string | null, maxAgeSeconds?: number) {
...
export function setRedirectCookie(resp: NextResponse, value: string, expiresDate?: Date) {
  const opts: any = { ...cookieOptions() }
